        ...
        <div className='bg-gray-800 flex flex-col justify-center h-screen w-screen'>
            <form className='max-w-[400px]    w-9/12   mx-auto bg-gray-900 p-8 px-8 rounded-lg' onSubmit={handleSubmit}>
              ...
              <div className='flex flex-col text-gray-400 py-2'>
                ...
                <input className='rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="text" autoComplete='off' value={clientLogin.name} onChange={handleInput} name="name" />
              </div>
              <div className='flex flex-col text-gray-400 py-2'>
                <label>Password</label>
                <input className='rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' type="password" autoComplete='off' value={clientLogin.password} onChange={handleInput} name="password" />
              </div>
